...
$config = array (
	...
	'components' => array(
		...
		'rewrite_rules' => array (
            ...
            /*'instagram' => array(
				'title' => __('Instagram', 'academy'),
				'name' => 'instagram',
				'rule' => 'instagram/?',
				'rewrite' => 'index.php?instagram=1',
				'position' => 'top',
				'authorized' => false,
			),*/
		...
		'custom_menus' => array (
			array(
				'slug' => 'header-menu',
				'name' => __('Menu in the header', 'academy'),
			),
            ...
            array(
				...
				'name' => __('Footer QUICK LINKS', 'academy'),
			)
		),
		...
		'user_styles' => array(
			...
			array(	
				'name' => 'general',
				'uri' => CHILD_URI.'css/all.css',				
			),

                        //slick
			array(	
				'name' => 'slick',
				'uri' => CHILD_URI.'js/slick/slick.css',				
			),
		),
		...
		'user_scripts' => array(
			...
			array(
				'name' => 'slick',
				'uri' => THEME_URI.'js/slick/slick.min.js',
				'options' => array(
					'templateDirectory' => THEME_URI,
				),
			),
                        ...
                        array(
				'name' => 'countdown',
				'uri' => THEME_URI.'js/countdown/countdown.js',
				'options' => array(
					'templateDirectory' => THEME_URI,
				),
			),
